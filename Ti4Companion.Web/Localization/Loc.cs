...
public class Loc
{
    ...
    private static readonly Dictionary<string, (string En, string De)> Strings = new()
    {
        ...
        ["agenda.remaining"] = ("left", "übrig"),
        ["agenda.recordInfluence"] = ("Record each player's influence before voting", "Einfluss jedes Spielers vor der Abstimmung eintragen"),
        ["agenda.nowVoting"] = ("Now voting", "Es wählt"),
        ["agenda.yourTurn"] = ("Your turn to vote", "Du bist dran"),
        ["agenda.votingDone"] = ("All votes are in.", "Alle Stimmen abgegeben."),
        ["agenda.confirmVote"] = ("Confirm vote", "Stimme bestätigen"),
        ["agenda.reverseOrder"] = ("Reverse order", "Reihenfolge umkehren"),
        ["agenda.notYet"] = ("Waiting their turn", "Wartet auf seinen Zug"),
